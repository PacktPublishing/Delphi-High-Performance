...
// (DO NOT EDIT: machine generated header) 'FMX.AbReg.pas' rev: 31.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_ABREG)
using namespace Fmx::Abreg;
#endif
